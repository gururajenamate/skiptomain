sap.ui.define([
    ...
    function (Controller, JSONModel) {
        ...
        return Controller.extend("skiptomain.controller.Main", {
            onInit: function () {
                this.FirstTabPress = false;
                document.addEventListener("keyup", function (event) {
                    if (event.keyCode === 9) {
                        if (!this.FirstTabPress) {
                            // sap.m.MessageBox.confirm("Skip to Main Content?", {
                            //     actions: ["Yes", "No"],
                            //     emphasizedAction: "Yes",
                            //     onClose: function (sAction) {
                            //         if (sAction === "Yes") {
                            //             this.getView().byId("action3").focus();
                            //         }
                            //     }.bind(this)
                            // });
                            this.getView().byId("skiptomaincontent").setVisible(true);
                            setTimeout(function(){
                                this.getView().byId("skiptomaincontent_action").focus();
                            }.bind(this), 200)
                            
                        }else {
                            this.getView().byId("skiptomaincontent").setVisible(false);
                        }
                        this.FirstTabPress = true;
                    }
                }.bind(this));
            ...
            onSkiptomaincontent: function() {
                this.getView().byId("action1").focus();
                this.getView().byId("skiptomaincontent").setVisible(false);
            }
        });
    });
